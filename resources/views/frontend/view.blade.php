                        ...
                        <div>
                            <label for="darkToggler"
                                ...
                                <svg viewBox="0 0 23 23"
                                    class=" a1C dark:aj a1D a1E md:a1F md:a1G"
                                    fill="none">
                                    <path
                ...
                <div class="a7 md:aU/3 lg:a1_/2 xl:a1_/3 ae">
                    <div class=" ad aw dark:av a33 a13 a2p a1V wow fadeInUp" data-wow-delay=".1s">
                        <a href="javascript:void(0)" class="a7 ah ad">
                            ...
                            <img src="{{ optional($problem->media)->first()->name['url']?? 'https://picsum.photos/1024?random='.rand(1, 50) }}" alt="image" class="a7 h-96" />
                        </a>
                        <div
                            ...
                            <p
                                class=" a a1 a1 a3 a2 a2 a2 a2 dark:a2o dark:a2" style="color: #fff; background-color: transparent; margin-top: 10px">
