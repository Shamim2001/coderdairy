            ...
            <div class="a8 a1K a1x ab[-16px]">
                ...
                ">
                      ...
                      ">
                                        ...
                                        {{ Carbon\Carbon::parse($problems->created_at)->format('Y-m-d') }}
                                    </p>
                                    <p
                                        class="
                        a8
                  ...
                  ">
                            ...
                            <div class="a7 a1c a2p a1V">
                                <img src="{{ optional($problems->media)->first()->name['url'] ?? 'https://picsum.photos/1024/500?random=' . rand(1, 50) }}"
                  ...
                  ">
                            ...
                            <div class=" a13 a2p a2Y md:a2Z lg:a2Y xl:a2Z a1k a29 ad a1H a1V">
                                <!-- solutionn Overview -->
                                @forelse ($problems->solutions as $index=>$solution)
                                    <!-- solutionn Overview -->
                                    <div class="card mt-6">
                                        <!-- header -->
                                        <div class="flex flex-row justify-between accordion"
                                            style="background-color: #16215B;">
                                            <h1 class="h6 text-gray-400">Solution #{{ $index + 1 }} </h1>
                                        </div>
                                        <!-- end header -->
                                ...
                                <span class="a3 a5 a4 a1Y[-1]">
                                    <svg width="132" height="109" viewBox="0 0 132 109" fill="none"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_111:606" x1="94.7523" y1="82.0246"
                                                x2="8.40951" y2="52.0609" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="white" stop-opacity="0.06" />
                                                <stop offset="1" stop-color="white" stop-opacity="0" />
                                            </linearGradient>
                                            <linearGradient id="paint1_linear_111:606" x1="90.3206" y1="58.4236"
                                                x2="1.16149" y2="50.8365" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="white" stop-opacity="0.06" />
                                                <stop offset="1" stop-color="white" stop-opacity="0" />
                                            </linearGradient>
                                        </defs>
                                ...
                                <span class="a3 a_ a1X a1Y[-1]">
                                    <svg width="53" height="30" viewBox="0 0 53 30" fill="none"
                                        ...
                                        <mask id="mask0_111:596" style="mask-type: alpha" maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="75" height="75">
                                            <circle opacity="0.8" cx="37.5" cy="37.5" r="37.5" fill="#4A6CF7" />
                                        </mask>
                                        <g mask="url(#mask0_111:596)">
                                            <circle opacity="0.8" cx="37.5" cy="37.5" r="37.5"
                                        ...
                                        <defs>
                                            <filter id="filter0_f_111:596" x="4.36768" y="-16.5881" width="72.8823"
                                                height="72.8823" filterUnits="userSpaceOnUse"
                                            ...
                                            <radialGradient id="paint0_radial_111:596" cx="0" cy="0" r="1"
                            ...
                            <div class="sm:a8 a9 ac">
                                <div class="a2v">
                                    <h5 class="a1R a1S a1b a30">
                                        Popular Tags :
                                    </h5>
                                    <div class="a8 a9">

                                        @foreach ($problems->tags as $tag)
                                            <a href="" class=" aM a9 a1x aK ae a2G a13 a1k a29 a1S hover:a31 hover:a ">
                                                {{ $tag->name }}
                                            </a>
                                        @endforeach
                                ...
                                {{-- share --}}
                                <div class="a2v">
                                    <h5 class=" a1R a1S a1b sm:a2H a30 ">Share this post : </h5>
                                    <div class="a8 a9 sm:a1d">
                                        <a href="javascript:void(0)"
                                            class=" aM a9 a1x a1s a1t sm:a32 a13 a1k a29 a1S hover:a31 hover:a ">
                                        ...
                                        <a href="javascript:void(0)"
                                            class=" aM a9 a1x a1s a1t a32 a13 a1k a29 a1S hover:a31 hover:a ">
