...
@section('content')
    ...
    <div id="add_new_tag_dialog" class="zoom-anim-dialog mfp-hide">
        ...
        <input type="text" name="new_tag" class="border my-2 border-teal-600 focus:outline-none px-2 py-1">
        <button type="button" id="add_new_tag"
            class="border my-2 border-teal-600 bg-teal-600 text-white focus:outline-none px-2 py-1">
            Add
        </button>
    </div>
@endsection
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.error) {
                                ...
                                // add to list
                                $('.tag_list').prepend('<input checked type="checkbox" id="'+tag.slug+'" name="tags[]" value="'+tag.id+'"><label for="'+tag.id+'" class="mr-2 ml-1 cursor-pointer">'+tag.name+'</label>');
                            }
